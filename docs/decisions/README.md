...
- 설계 정본은 PR #15로 병합·검증됐다. 구현 기준선은 `main@6c142b1739f677374094e2f2d8821904c53d1f2a`, tree `91486c3d465ce4a53a699a00dc38232f40c7a9dc`다.
- 이후 사용자가 M6-0 구현을 명시적으로 승인했다. 원문에 남아 있는 구현 미승인·미착수 문구는 설계 승인 당시의 기록으로 보존한다. 정본의 바이트와 SHA-256은 변경하지 않는다.
- 현재 구현 승인은 `GRANTED`이며 B의 구현 검토와 구현 PR 병합 승인은 별개다. 세부 구현과 관찰은 [M6-0 구현·관찰 기록](../m6-0-implementation.md)에 기록한다.
